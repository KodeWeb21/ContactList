...
<body>
    ...
    <main class="main">
       ...
       <?php
        ...
        $nombreContacto = (isset($_GET['q']))? $_GET['q'] : NULL;
        $contactos = $objUsuario->buscarContacto($nombreContacto,$idUsuario['ID_USUARIO']);
       if($nombreContacto !== NULL && $contactos !== NULL){
           foreach($contactos as $key=>$contacto){
                print_r(
                    ...
                    {$contacto['NOMBRE_CONTACTO'][0]}
                    </span>
                    </div>
                    <div class='content-text'>
                        <h3 class='nombre'>{$contacto['NOMBRE_CONTACTO']}</h3>
                        <div class='buttons'>
           ...
           print_r(
               ...
               <div class="message-body">
                    Al parecer este contacto no existe.
               </div>
             </article>
